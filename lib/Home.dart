...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    decoration: BoxDecoration(
      image: DecorationImage(image: NetworkImage("https://images.unsplash.com/photo-1564659907532-6b5f98c8e70f?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTQ2fHxjaHJpc3R8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60"),
      fit: BoxFit.cover),
    ),
        child: Column(
